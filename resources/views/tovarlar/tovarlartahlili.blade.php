...
@section('content')
    ...
    <div class="content-body">
        <div class="page-titles" style="justify-content:center !important">
            <ol class="breadcrumb">
                <li>
                    <h5 class="heading mb-0 text-primary text-center text-uppercase fw-bold">Товарлар қолдиғини кўриб олиш
                        бўлими
                    </h5>
                </li>
            </ol>
                ...
                <div class="col-12">
                    <div class="card h-auto">
                        <div class="page-titles">
                            ...
                            <ol class="breadcrumb">
                                <li>
                                    <h5 class="bc-title text-primary">Товарлар тахлили кирим нархи буйича</h5>
                                </li>
                            </ol>
                        ...
                        <div class="card-body">
                            <div class="people-list dz-scroll">
                                <div id="tabpros" style="font-size: 12px;">
        ...
        <script>
            function tabyuklash() {
                ...
                if (id > 0) {
                    $.ajax({
                        url: "{{ route('TovarQoldigi.index') }}/" + id,
                        method: "GET",
                        data: {
                            filial: id,
                            _token: csrf
            ...
            $(document).ready(function() {
                ...
                $("#filial").change(function() {
                    ...
                    if (id > 0) {
                        $.ajax({
                            url: "{{ route('TovarQoldigi.index') }}/" + id + "/edit",
                            method: "GET",
                            data: {
                                id: id,
                            },
