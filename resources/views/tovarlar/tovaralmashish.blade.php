...
@section('content')
    ...
    <div class="content-body">
        <div class="page-titles" style="justify-content:center !important">
            <ol class="breadcrumb">
                <li>
                    <h5 class="heading mb-0 text-primary text-center text-uppercase fw-bold">Товарларни бошқа филиалларга
                        ўтказиш бўлими
                    </h5>
                </li>
            </ol>
                ...
                <div class="col-12">
                    <div class="card h-auto">
                        <div class="page-titles">
                            <ol class="breadcrumb">
                                <li>
                                    <h5 class="bc-title text-primary">Бошқа филиалларга ўтказилган товарлар рўйхати</h5>
                                </li>
                            </ol>
        ...
        <div id="add" class="modal fade bd-example-modal-lg" data-bs-backdrop="static" data-bs-keyboard="true"
