...
@section('content')
    ...
    <div class="content-body">
        <div class="page-titles" style="justify-content:center !important">
            <ol class="breadcrumb">
                <li>
                    <h5 class="heading mb-0 text-primary text-center text-uppercase fw-bold">Жами туловларни куриш бўлими
                    </h5>
                </li>
            </ol>
        </div>
            ...
            $(document).ready(function() {
                ...
                $('#saqlash').on('click', function() {
                    ...
                    if (boshkun > yakunkun) {
                        ...
                        $.ajax({
                            url: "{{ route('OfficeJamiTulovlar.store') }}",
                            method: "post",
                            data: {
                                _token: "{{ csrf_token() }}",
                                boshkun: boshkun,
