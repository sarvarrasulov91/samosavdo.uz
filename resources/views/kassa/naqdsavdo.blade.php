...
@section('content')
    ...
    <div class="content-body">
        <div class="page-titles" style="justify-content:center !important">
            <ol class="breadcrumb">
                <li>
                    <h5 class="heading mb-0 text-primary text-center text-uppercase fw-bold">нақд савдоларни рўйхатга
                        олиш бўлими
                    </h5>
                </li>
            </ol>
            ...
            <div class="modal-dialog modal-lg" style="max-width: 80%;">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title">Нақд савдоларни рўйхатга олиш ойнаси</h5>
