...
@section('content')
    ...
    <div class="content-body">
        <div class="page-titles" style="justify-content:center !important">
            <ol class="breadcrumb">
                <li>
                    <h5 class="heading mb-0 text-primary text-center text-uppercase fw-bold">Алокабанк Авто туловларни куриш булими
                    </h5>
                </li>
            </ol>
        </div>
        ...
        <script>
            ...
            $(document).ready(function() {
                ...
                $('#saqlash').on('click', function() {
                    ...
                    if (boshkun > yakunkun) {
                        ...
                        $.ajax({
                            url: "{{ route('officeavtotulov.store') }}",
                            method: "POST",
                            data: {
                                _token: "{{ csrf_token() }}",
                                boshkun: boshkun,
            ...
            $(document).on('click', '#kivitpechat', function() {
                ...
                $.ajax({
                    url: "{{ route('officeavtotulov.index') }}/" + id,
                    method: "PUT",
                    data: {
                        _token: csrf,
                        id: id,
