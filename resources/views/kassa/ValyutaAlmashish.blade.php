...
@section('content')
    ...
    <div class="content-body">
        <div class="page-titles" style="justify-content:center !important">
            <ol class="breadcrumb">
                <li>
                    <h5 class="heading mb-0 text-primary text-center text-uppercase fw-bold"> Сўмни долларга алмаштириш бўлими
                    </h5>
                </li>
            </ol>
        </div>
        ...
        <!-- Modal chiqim_add -->
        <div id="kirim" class="modal fade bd-example-modal-lg" data-bs-backdrop="static" data-bs-keyboard="true" tabindex="-1" role="dialog" aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title">Валюта алмаштириш ойнаси</h5>
                    ...
                    <div class="modal-body">
                        <form id="kirim_add" method="POST">
                            ...
                            <div class="p-1">
                                <label>Доллар суммасини киритинг
                                    <span class="text-danger">*</span>
                                </label>
                                <input type="text" name="dsumma" id="dsumma" class="form-control" placeholder="Доллар сумма..." maxlength="13">
                                <span id="dsumma_error" class="text-danger error-text"></span>
                            </div>
                            <div class="p-1">
        ...
        <script>
            function tabyuklash() {
                $.ajax({
                    url: "{{ route('ValyutaAlmashish.create') }}",
                    type: 'GET',
                    data: "",
            ...
            $(document).ready(function() {
                ...
                $('#kirim_add').on('submit', function(e) {
                    ...
                    $.ajax({
                        url: "{{ route('ValyutaAlmashish.store') }}",
                        type: 'POST',
                        data: formData,
            ...
            $(document).on('click', '#kirimudalit', function() {
                ...
                if (uzid == true) {
                    ...
                    $.ajax({
                        url: "{{ route('ValyutaAlmashish.index') }}/" + id,
                        method: "DELETE",
                        data: {
                            id: id
                        },
            ...
            $(function($) {
                const inputSelectors = ['#naqd', '#plastik', '#click', '#hr' , '#dsumma'];
