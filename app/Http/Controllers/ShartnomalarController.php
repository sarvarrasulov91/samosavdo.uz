...
class ShartnomalarController extends Controller
{
    ...
    public function show(Request $request, string $id)
    {
       ...
       <br>
        ...
        <h5 class=" text-center text-uppercase" style="color: RoyalBlue;">Бонусга олинган товарлар рўйхати</h5>
        <table class="table table-bordered table-hover">
            <thead>
                <tr class="text-center text-bold text-primary align-middle">
                    <th>№</th>
            ...
            <tbody id="tab1">';
                ...
                foreach ($bonusTovarlar as $bonus) {
                    echo "
                    <tr class='text-center align-middle'>
                        <td>" . $j . "</td>
                        <td>" . $bonus->tmodel_id . "</td>
                        <td>" . $bonus->kun . "</td>
                        <td>" . $bonus->tur->tur_name . ' ' . $bonus->brend->brend_name . ' ' . $bonus->tmodel->model_name . "</td>
                        <td>" . number_format($bonus->msumma, 0, ',', ' ') . "</td>
                        <td>" . $bonus->shtrix_kod . "</td>
                    </tr>";
                    $jamisumma += $bonus->msumma;
                    $j++;
                }
                echo '
                <tr class="text-center align-middle fw-bold">
        ...
        <div class="row my-3">
            <div class="col-xl-12 m-auto">
                <h5 class=" text-center text-uppercase" style="color: RoyalBlue;">Изохлар</h5>
                <div class="p-1 border border-light rounded">
                    <p>'.$shartnom->izox.'</p>
                </div>
            </div>
        </div>';
            ...
            <div class="modal-body m-10">
                <div class="flex items-center justify-center bg-white ">
                    <div id="certificate" class="text-center p-2">
                        <h4 style="text-align: center; font-size: 20px; margin-bottom: -10px;"><b>Ш А Р Т Н О М А № ' . $shartnom->shid . '</b></h4>
                ...
                <table class="table-sm table-hover" style="font-size: 12px; text-align: center; width:100%; border: 1px solid black;">
                    ...
                    <tr class="align-middle text-muted">
                        ...
                        <td style="text-align: center; border: 1px solid black; border-collapse: collapse; font-size: 8pt">' . number_format(round(($savdosumma + $xis_foiz - $oldindantulov - $chegirma) / $shartnom->muddat, -2), 2, ",", " ") . '</td>
            ...
            <div class="modal-body">
                <div class="flex items-center justify-center bg-white p-5">
                    <div id="certificate" class="text-center p-2">
                            ...
                            <br>
                            <h4 style="text-align: center; font-size: 30px;">Шартнома № '.$shartnom->shid.'</h4>
    ...
    public function destroy(string $id)
    {
        ...
        echo'
            <div class="modal-body m-0">
                <div class="flex items-center justify-center bg-white ">
                    <div id="certificate" class="text-center p-2">
                        <h4 style="text-align:center; margin-bottom: -5px;">ЮК ХАТИ № ' . $shartnom->shid . '</h4>
                        <div>
                            <p style="text-align:center; margin-bottom: 0px; margin-left: 10%; margin-right: 10%;">' . $kun . ' йилдаги № '. $shartnom->shid .'-сонли муддатли тўлов шарти билан тузилган олди-сотди шартномасига асосан</p>
                        </div>
                    ...
                    <p style="margin-bottom: -15px; text-align: right;">
                        Шартнома № '. $shartnom->shid .' га илова
                    </p>
                    <br />
                    <table style="width:100%; border: 1px solid black; border-collapse: collapse; font-size:14px; " id="tovarjad">
                        <tr>
                    ...
                    <table style="width:100%; border: 1px solid black; border-collapse: collapse; font-size:14px;" id="tovarjad">
                        ...
                        while ($i <= $koyi) {
                            ...
                            $du2 = Carbon::parse($du22)->locale('ru')->translatedFormat('F Y');
                            ...
                            echo '<tr class="align-middle text-center">
                                ...
                                <td style="text-align: center; border: 1px solid black; border-collapse: collapse;">' .$tkun.'-'.$du2 . ' йил</td>';
                                if($i==0){
